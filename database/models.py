...
class UserRating(Base):
    ...
    id = sa.Column(sa.Integer, primary_key=True)
    user_from_id = sa.Column(sa.Integer, sa.ForeignKey(User.id, ondelete='CASCADE'))
    user_to_id = sa.Column(sa.Integer, sa.ForeignKey(User.id, ondelete='CASCADE'))
...
class Report(Base):
    ...
    id = sa.Column(sa.Integer, primary_key=True)
    report_from_id = sa.Column(sa.Integer, sa.ForeignKey(User.id, ondelete='CASCADE'))
    report_to_id = sa.Column(sa.Integer, sa.ForeignKey(User.id, ondelete='CASCADE'))
